---
title: "Navigating STEM as a Blind PhD Student: A Personal Journey"
date: 2024-11-13
summary: "How I make an ordinary differential equations textbook accessible — and why today's tools still fall short."
tags: [Accessibility, STEM, Braille]
...
**Why XML?**
In my experience, XML files work better with screen readers like [JAWS](https://www.freedomscientific.com/products/software/jaws/) and [NVDA](https://www.nvaccess.org/) in Word compared to regular DOCX files. I'd used this method before, and it was usually quicker and smoother. This time, though, I hit a major roadblock: matrices.
...
For a while, my [HIMS-6 Braille display](https://hims-inc.com/product/braille-sense-6/) saved the day. Plugging it into my computer made reading more manageable, though matrices were still a pain. I had to interact with each one individually, which, for an ODE textbook, is no small task.

Next, I tried converting the file with [Duxbury](https://www.duxburysystems.com/) and embossing it in Braille. Unfortunately, this was even more frustrating. Duxbury struggled with some math symbols and messed up the formatting of the matrices.
...
1. **Get the PDF**: Either download it or scan a physical copy at the highest resolution possible.
2. **Run it Through OCR**: Convert the PDF into a more accessible format like XML, DOCX, TeX, or HTML. My go-to OCR tools are:
    - [Abbyy FineReader](https://www.abbyy.com/en-us/finereader/)
    - [MathPix](https://mathpix.com/)
    - [InftyReader](https://www.inftyproject.org/en/software.html)
3. **Check the Output**: If the document is readable in one of these formats, great. If not, run it through Duxbury and either emboss it or use a Braille display.

## The Problems

1. **OCR Isn't Perfect**: Especially with math-heavy content, OCR tools can't always be trusted to get everything right.
2. **Duxbury's Limitations**: While it's the best Braille conversion software out there, it struggles with more complex math symbols and often loses the spatial organization of formulas.
3. **Time and Cost**: This process takes forever, and the software and devices involved aren't cheap. Even after all that effort, it doesn't always work.
